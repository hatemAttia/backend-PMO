...
export default (app) => {
  ...
  app
    .route("/team-img/:id")
    .post(uploadimages.single("file"), teamController.updateImage);
  ...
  app
    .route("/news-img/:id")
    .post(uploadimages.single("file"), newsController.updateImage);
  ...
  app
    .route("/file-name/:id")
    .post(uploadFile.single("file"), fileController.updateFileName);
  ...
  app
    .route("/opportunity-img/:id")
    .post(uploadimages.single("file"), opportunityController.updateImage);
  ...
  app.route("/user/:id").get(userController.getOneAdmin);
  app.route("/user-all").get(userController.getAllAdmins);
  app
    .route("/user-img/:id")
    .post(uploadimages.single("file"), userController.updateImage);
